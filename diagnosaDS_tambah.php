<div class="page-header">
    <h1>Tambah Diagnosa <i>Dempster Shafer</i></h1>
</div>
<div class="row">
    <div class="col-sm-6">
        ...
        <form method="post">
            ...
            <div class="form-group">
                <button class="btn btn-primary" onclick="return confirm('Yakin Ingin Menyimpan Data Diagnosa?')" title="Simpan Data Diagnosa"><span class="glyphicon glyphicon-save"></span> Simpan</button>
